...
def epsilon_greedy_nonstationary(bandit, num_steps=1000, epsilon=0.1):
    """
    Epsilon-greedy algorithm for the non-stationary bandit.
...
num_steps = 1000
epsilon = 0.1
rewards, action_counts, action_history = epsilon_greedy_nonstationary(bandit, num_steps, epsilon)
...
print("Final Estimated Rewards:", estimated_rewards)
